...
class TopSellingMedicinesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Top Selling Medicines'),
      ),
      body: Padding(
          ...
          children: [
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                stream: productsRef
                    .where('category', isEqualTo: 'FZbeNZcv0Wz3GJYMIaeH') // Fetch only Support Aid products
                    .snapshots(),
